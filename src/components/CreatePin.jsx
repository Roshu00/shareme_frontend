      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-5/4 w-full">
          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className="absolute bottom-3 right-3 rounded-full p-3 bg-white text-xl cursor-pointer hover-shadow-md outline-none transition-all duration-500 ease-in-out"
                  onClick={() => {
                    setImageAsset(null);
                  }}
                >
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          <input
            ...
            className="outline-none text-xl sm:text3xl font-bold border-b-2 border-gray-200 p-2"
          />
          {user && (
          ...
          <div className="flex flex-col">
            <div>
              ...
              <select
                ...
                className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 cursor-pointer rounded-md"
              >
