  ...
  return (
    ...
    >
      ...
      <div className="w-full p-5 flex-1 xl:min-w-620">
        ...
        <Link
          to={`user-profil/${pinDetail.postedBy?._id}`}
        ...
        <div className="max-h-370 owerflow-y-auto">
          {pinDetail?.comments?.map((comment, i) => (
            ...
            >
              <img
                ...
                alt="user-profile"
                className="w-10 h-10 rounded-full cursor-ponter"
              />
        ...
        <div className="flex flex-wrap mt-6 gap-3 items-center">
          <Link to={`user-profil/${pinDetail.postedBy?._id}`}>
            <img
              src={pinDetail.postedBy?.image}
              alt="user-profile"
